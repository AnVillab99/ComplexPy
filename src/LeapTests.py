...
class TestComplexVector(unittest.TestCase):
    ...
    def testRendijaCuantica(self):
        m1=m.empty(11,11)
        m1.fix(1,0,com.Complex((-1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(2,0,com.Complex((-1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(3,0,com.Complex((-1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(4,1,com.Complex((-1/math.sqrt(6)),(1/math.sqrt(6))))
        m1.fix(5,1,com.Complex((-1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(6,1,com.Complex((1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(6,2,com.Complex((-1/math.sqrt(6)),(1/math.sqrt(6))))
        m1.fix(7,2,com.Complex((-1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(8,2,com.Complex((1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(8,3,com.Complex((-1/math.sqrt(6)),(1/math.sqrt(6))))
        m1.fix(9,3,com.Complex((-1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(10,3,com.Complex((-1/math.sqrt(6)),(-1/math.sqrt(6))))
        m1.fix(4,4,com.Complex(1,0))
        m1.fix(5,5,com.Complex(1,0))
        m1.fix(6,6,com.Complex(1,0))
        m1.fix(7,7,com.Complex(1,0))
